...
1. 完整解压 `Mayday-Bubu-Windows-10-11-Codex-Only-v1.0.2.zip`。
...
- `Codex-Only` v1.0.2：只显示 Codex 额度，面板自动缩短，并且不会请求 BTC/ETH 行情。

`v1.0.2` 会先清理旧宠物目录、校验新图集并重新写入宠物选择，避免 Windows 升级安装后仍显示旧宠物。
