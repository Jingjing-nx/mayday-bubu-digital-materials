...
WEB3_VOCABULARY_MARKER="$ROOT/WEB3-VOCABULARY.txt"
ULTIMATE_MARKER="$ROOT/ULTIMATE.txt"
...
if [[ -f "$WEB3_VOCABULARY_MARKER" ]]; then
  PACKAGE_VERSION="30"
  PANEL_FEATURE_NAME="Codex 额度 + BTC 面板 + Web3 单词卡"
fi
if [[ -f "$ULTIMATE_MARKER" ]]; then
  PACKAGE_VERSION="31"
  PANEL_FEATURE_NAME="Codex 额度 + BTC 面板 + Web3 单词卡 + 本地音乐"
fi
